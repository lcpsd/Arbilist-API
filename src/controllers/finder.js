const classMaker = require('../tools/classMaker')
const diff_tool = require('../tools/diff')

module.exports = {
    async init(req, res){

        let {symbol} = req.body, {btcQty} = req.body, {exchangeNames} = req.body
        ...
        //future implements: fees calculator
